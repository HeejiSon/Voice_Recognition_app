...
public class DatabaseHelper extends SQLiteOpenHelper {
   ...
   /* public static final String DATABASE_NAME = "kiosk.db"; // 데이터베이스 명
    public static final String TABLE_NAME = "menu"; // 테이블 명
    Context context;

    // 테이블 항목
    public static final String COL_1 = "menu_num";
    public static final String COL_2 = "category_num";
    public static final String COL_3 = "menu_name";
    public static final String COL_4 = "menu_price";
